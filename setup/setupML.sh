...
# Load Data JSON
curl --anyauth --user $ADMIN_UID:$ADMIN_PWD -X PUT -T ./config/572773090364674048.json "http://$ML_HOST:7010/v1/documents?uri=/tweets/572773090364674048.json&format=json"
